...
INSERT INTO seguimiento (tarea, ce, nota, ponderacion, observaciones, asignatura_matr) VALUES
(1, 1, 7.5, 0.7, 'Instalación correcta', 1), 
(2, 3, 8.0, 0.8, 'Simulación completa', 1),  
(3, 4, 6.5, 0.6, 'Diseño inicial', 1),      
(4, 5, 7.0, 0.7, 'Consultas básicas', 1), 
(5, 6, 8.0, 0.8, 'Código funcional', 1),      
(6, 7, 7.5, 0.7, 'Pruebas básicas', 1),      
(7, 8, 9.0, 0.9, 'Estructura bien definida', 1),  
(8, 9, 8.5, 0.8, 'Estilos aplicados', 1),    
(9, 10, 7.0, 0.7, 'IDE configurado', 1),      
(10, 11, 6.5, 0.6, 'Control inicial', 1),     
(13, 14, 8.0, 0.8, 'Análisis detallado', 1),    
(14, 15, 7.5, 0.7, 'Propuestas concretas', 1), 
(1, 1, 8.0, 0.8, 'Instalación correcta', 2),   
(2, 3, 7.5, 0.7, 'Simulación completa', 2),  
(3, 4, 9.0, 0.9, 'Diseño optimizado', 2),      
(4, 5, 8.5, 0.8, 'Consultas eficientes', 2),   
(5, 6, 7.0, 0.7, 'Código limpio', 2),         
(6, 7, 6.5, 0.6, 'Pruebas exhaustivas', 2),    
(7, 8, 8.5, 0.8, 'Estructura clara', 2),       
(8, 9, 8.0, 0.7, 'Estilos creativos', 2),     
(9, 10, 9.0, 0.9, 'IDE optimizado', 2),       
(10, 11, 8.5, 0.8, 'Control avanzado', 2),     
(13, 14, 7.0, 0.7, 'Análisis detallado', 2),    
(14, 15, 6.5, 0.6, 'Propuestas viables', 2),
(1, 1, 9.0, 0.9, 'Instalación completa', 3),  
(2, 3, 8.5, 0.8, 'Simulación eficiente', 3),  
(3, 4, 7.0, 0.7, 'Diseño bien estructurado', 3), 
(4, 5, 6.5, 0.6, 'Consultas optimizadas', 3), 
(5, 6, 8.5, 0.8, 'Código documentado', 3),    
(6, 7, 8.0, 0.7, 'Pruebas automatizadas', 3),   
(7, 8, 7.0, 0.7, 'Estructura semántica', 3),    
(8, 9, 6.5, 0.6, 'Estilos coherentes', 3),     
(9, 10, 8.0, 0.8, 'IDE personalizado', 3),      
(10, 11, 7.5, 0.7, 'Control riguroso', 3),     
(13, 14, 6.5, 0.6, 'Análisis profundo', 3),     
(14, 15, 9.0, 0.9, 'Propuestas innovadoras', 3),  
(1, 1, 7.5, 0.7, 'Instalación correcta', 1),   
(2, 3, 8.0, 0.8, 'Simulación completa', 1),   
(3, 4, 6.5, 0.6, 'Diseño inicial', 2),        
(4, 5, 7.0, 0.7, 'Consultas básicas', 2),     
(5, 6, 8.0, 0.8, 'Código funcional', 3),      
(6, 7, 7.5, 0.7, 'Pruebas básicas', 3),       
(7, 8, 9.0, 0.9, 'Estructura bien definida', 4),  
(8, 9, 8.5, 0.8, 'Estilos aplicados', 4),    
(9, 10, 7.0, 0.7, 'IDE configurado', 5),     
(10, 11, 6.5, 0.6, 'Control inicial', 5),      
(11, 12, 8.0, 0.8, 'CV bien estructurado', 6),    
(12, 13, 7.5, 0.7, 'Entrevista correcta', 6),    
(13, 14, 8.0, 0.8, 'Análisis detallado', 7),   
(14, 15, 7.5, 0.7, 'Propuestas concretas', 7),
(1, 1, 8.0, 0.8, 'Instalación correcta', 8),  
(2, 3, 7.5, 0.7, 'Simulación completa', 8),  
(3, 4, 9.0, 0.9, 'Diseño optimizado', 9),      
(4, 5, 8.5, 0.8, 'Consultas eficientes', 9),    
(5, 6, 7.0, 0.7, 'Código limpio', 10),          
(6, 7, 6.5, 0.6, 'Pruebas exhaustivas', 10),    
(7, 8, 8.5, 0.8, 'Estructura clara', 11),       
(8, 9, 8.0, 0.7, 'Estilos creativos', 11),     
(9, 10, 9.0, 0.9, 'IDE optimizado', 12),       
(10, 11, 8.5, 0.8, 'Control avanzado', 12),     
(11, 12, 7.0, 0.7, 'CV bien estructurado', 13),   
(12, 13, 6.5, 0.6, 'Entrevista correcta', 13),    
(13, 14, 7.0, 0.7, 'Análisis detallado', 14),    
(14, 15, 6.5, 0.6, 'Propuestas viables', 14),    
(1, 1, 9.0, 0.9, 'Instalación completa', 15),   
(2, 3, 8.5, 0.8, 'Simulación eficiente', 15),  
(3, 4, 7.0, 0.7, 'Diseño bien estructurado', 16), 
(4, 5, 6.5, 0.6, 'Consultas optimizadas', 16), 
(5, 6, 8.5, 0.8, 'Código documentado', 17),    
(6, 7, 8.0, 0.7, 'Pruebas automatizadas', 17),   
(7, 8, 7.0, 0.7, 'Estructura semántica', 18),    
(8, 9, 6.5, 0.6, 'Estilos coherentes', 18),  
(9, 10, 8.0, 0.8, 'IDE personalizado', 19),     
(10, 11, 7.5, 0.7, 'Control riguroso', 19),     
(11, 12, 6.5, 0.6, 'CV bien estructurado', 20),    
(12, 13, 9.0, 0.9, 'Entrevista correcta', 20),     
(13, 14, 6.5, 0.6, 'Análisis profundo', 21),     
(14, 15, 9.0, 0.9, 'Propuestas innovadoras', 21),  
(2, 3, 6.8, 0.6, 'Simulación básica', 46),         
(4, 5, 7.2, 0.7, 'Consultas iniciales', 47),    
(6, 7, 8.1, 0.8, 'Pruebas incompletas', 48),      
(8, 9, 9.0, 0.9, 'Estilos originales', 49),      
(10, 11, 8.5, 0.8, 'Control bien usado', 50),      
(12, 13, 7.0, 0.7, 'Simulación ok', 51),         
(14, 15, 6.5, 0.6, 'Poco concreto', 52),
(1, 1, 8.2, 0.8, 'Instalación correcta', 53),       
(3, 4, 7.9, 0.7, 'Diseño bien hecho', 54),        
(5, 6, 6.8, 0.6, 'Código legible', 55),          
(7, 8, 8.8, 0.9, 'Estructura semántica', 56),       
(9, 10, 9.2, 0.8, 'IDE configurado', 57),        
(11, 12, 8.1, 0.7, 'CV completo', 58),           
(13, 14, 7.9, 0.6, 'Análisis correcto', 59),
(2, 3, 9.0, 0.9, 'Simulación avanzada', 60),       
(4, 5, 8.5, 0.8, 'Consultas optimizadas', 61),    
(6, 7, 7.2, 0.7, 'Pruebas automatizadas', 62),    
(8, 9, 6.8, 0.6, 'Estilos consistentes', 63),     
(10, 11, 7.9, 0.7, 'Control exhaustivo', 64),    
(12, 13, 8.2, 0.8, 'Entrevista fluida', 65),       
(14, 15, 9.0, 0.9, 'Propuesta viable', 66),
(1, 1, 6.5, 0.6, 'Instalación básica', 67),       
(3, 4, 7.0, 0.7, 'Diseño inicial', 68),        
(5, 6, 8.0, 0.8, 'Código limpio', 69),         
(7, 8, 7.5, 0.7, 'Estructura correcta', 70),    
(9, 10, 9.0, 0.9, 'IDE configurado', 71),       
(11, 12, 8.5, 0.8, 'CV estructurado', 72),          
(13, 14, 7.0, 0.7, 'Análisis completo', 73),
(2, 3, 8.0, 0.8, 'Simulación completa', 74),       
(4, 5, 6.5, 0.6, 'Consultas lentas', 75),           
(6, 7, 7.0, 0.7, 'Pruebas incompletas', 76),       
(8, 9, 8.0, 0.8, 'Estilos originales', 77),    
(10, 11, 7.5, 0.7, 'Control inicial', 78),   
(12, 13, 9.0, 0.9, 'Entrevista fluida', 79),      
(14, 15, 8.5, 0.8, 'Propuesta creativa', 80),
(1, 1, 9.0, 0.9, 'Instalación óptima', 81),        
(3, 4, 8.0, 0.8, 'Diseño bien hecho', 82),         
(5, 6, 6.5, 0.6, 'Código claro', 83),          
(7, 8, 7.0, 0.7, 'Estructura semántica', 84),      
(9, 10, 8.0, 0.8, 'IDE personalizado', 85),         
(11, 12, 7.5, 0.7, 'CV detallado', 86),            
(13, 14, 9.0, 0.9, 'Análisis profundo', 87),
(1, 1, 8.2, 0.8, 'Instalación correcta y rápida', 158),
(3, 4, 7.9, 0.7, 'Diseño bien estructurado', 159),
(5, 6, 9.5, 0.9, 'Código elegante y eficiente', 160),
(7, 8, 8.8, 0.8, 'Estructura HTML5 semántica', 161),
(9, 10, 7.9, 0.7, 'IDE optimizado para el desarrollo', 162),
(11, 12, 7.5, 0.7, 'CV adaptado al sector', 163),
(13, 14, 9.0, 0.9, 'Análisis exhaustivo del impacto', 164),
(2, 3, 7.5, 0.7, 'Simulación precisa y completa', 165),
(4, 5, 8.5, 0.8, 'Consultas SQL muy eficientes', 166),
(6, 7, 7.0, 0.6, 'Pruebas unitarias básicas', 167),
(8, 9, 8.2, 0.8, 'Estilos CSS consistentes y atractivos', 168),
(10, 11, 9.5, 0.9, 'Control de versiones impecable', 169),
(12, 13, 8.5, 0.8, 'Preparación para la entrevista excelente', 170),
(14, 15, 7.5, 0.7, 'Propuesta sostenible y viable', 171),
(1, 1, 9.0, 0.9, 'Instalación personalizada y optimizada', 172),
(3, 4, 8.0, 0.8, 'Diseño ERD bien documentado', 173),
(5, 6, 7.2, 0.7, 'Código orientado a objetos', 174),
(7, 8, 6.8, 0.6, 'Estructura HTML correcta', 175),
(9, 10, 8.2, 0.8, 'IDE con plugins útiles', 176),
(11, 12, 9.0, 0.9, 'CV adaptado al puesto deseado', 177),
(13, 14, 8.5, 0.8, 'Análisis exhaustivo y claro', 178),
(2, 3, 7.9, 0.7, 'Simulación casi perfecta', 179),
(4, 5, 9.0, 0.9, 'Consultas muy optimizadas y rápidas', 180),
(6, 7, 8.5, 0.8, 'Pruebas unitarias y de integración', 181),
(8, 9, 7.5, 0.7, 'Estilos CSS adaptables a diferentes dispositivos', 182),
(10, 11, 7.0, 0.6, 'Control de versiones bien implementado', 183),
(12, 13, 8.2, 0.8, 'Entrevista fluida y con respuestas bien argumentadas', 184),
(14, 15, 9.0, 0.9, 'Propuesta innovadora y factible', 185),
(2, 3, 8.5, 0.8, 'Simulación muy detallada', 186),
(3, 4, 7.0, 0.7, 'Diseño conceptual claro', 187),
(5, 6, 8.8, 0.8, 'Código modular y reutilizable', 188),
(7, 8, 9.2, 0.9, 'Estructura semántica y accesible', 189),
(9, 10, 6.8, 0.6, 'IDE con herramientas avanzadas', 190),
(11, 12, 7.9, 0.7, 'CV bien enfocado al puesto', 191),
(13, 14, 8.2, 0.8, 'Análisis con datos precisos', 192),
(1, 1, 7.2, 0.7, 'Instalación completa', 193),
(4, 5, 8.0, 0.8, 'Consultas optimizadas', 194),
(6, 7, 9.0, 0.9, 'Pruebas exhaustivas', 195),
(8, 9, 6.5, 0.6, 'Estilos bien aplicados', 196),
(10, 11, 7.7, 0.7, 'Control centralizado', 197),
(12, 13, 8.8, 0.8, 'Entrevista correcta', 198),
(14, 15, 7.0, 0.7, 'Propuesta viable', 199),
(2, 3, 9.0, 0.9, 'Simulación innovadora', 200),
(3, 4, 8.8, 0.8, 'Diseño conceptual impecable', 201),
(5, 6, 7.5, 0.7, 'Código comentado y claro', 202),
(7, 8, 8.0, 0.8, 'Estructura semántica completa', 203),
(9, 10, 9.2, 0.9, 'IDE bien configurado', 204),
(11, 12, 6.9, 0.6, 'CV enfocado en habilidades', 205),
(13, 14, 8.8, 0.8, 'Análisis con datos actualizados', 206),
(1, 1, 7.7, 0.7, 'Instalación personalizada', 207),
(4, 5, 9.2, 0.9, 'Consultas muy eficientes', 208),
(6, 7, 8.0, 0.8, 'Pruebas unitarias automatizadas', 209),
(8, 9, 7.5, 0.7, 'Estilos bien aplicados y modernos', 210),
(10, 11, 6.8, 0.6, 'Control detallado del proyecto', 211),
(12, 13, 8.0, 0.8, 'Entrevista con respuestas claras', 212),
(14, 15, 9.2, 0.9, 'Propuesta innovadora y viable', 213);
